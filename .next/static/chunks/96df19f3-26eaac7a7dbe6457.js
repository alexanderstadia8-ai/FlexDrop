"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[106],{5954:function(e,t,n){n.d(t,{Bt:function(){return sE},EK:function(){return P},IO:function(){return se},JU:function(){return iV},QT:function(){return sg},Xo:function(){return ss},ad:function(){return iP},ar:function(){return sn},b9:function(){return so},cf:function(){return sw},hJ:function(){return iL},pl:function(){return sv}});var r,i,s,a,o=n(9522),l=n(2729),u=n(4416),h=n(852),c=n(2027),d=n(9894);n(5050);var f=n(1502).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sg(e){e=iN(e,iR);let t=iN(e.firestore,iF);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:o=>{s.Za(),t.enqueueAndForget(()=>rB(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rQ(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(iU(t),e._key).then(n=>s_(t,e,n))}class sy extends sc{constructor(e){super(),this.firestore=e}convertBytes(e){return new iq(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function sv(e,t,n){var r,i;e=iN(e,iR);let s=iN(e.firestore,iF),a=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return i=[(function(e,t,n,r,i,s={}){let a,o;let l=e.Qu(s.merge||s.mergeFields?2:0,t,n,i);i1("Data must be an object, but it was:",l,r);let u=iZ(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=(0,h.m9)(t))instanceof iB)return t._internalPath;if("string"==typeof t)return i4(e,t);throw i3("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iG(new eO(u),a,o)})(iY(s),"setDoc",e._key,a,null!==e.converter,n).toMutation(e._key,tL.none())],function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r3(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iU(s),i)}function sw(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iO(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iO(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iR)a=iN(e.firestore,iF),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](s_(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iN(e,iD);a=iN(n.firestore,iF),o=n._query;let r=new sy(a);s={next:e=>{t[u]&&t[u](new sp(a,r,n,e))},error:t[u+1],complete:t[u+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
